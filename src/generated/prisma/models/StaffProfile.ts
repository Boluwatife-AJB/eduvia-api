 ...
 */
export type StaffProfileModel =
  runtime.Types.Result.DefaultSelection<Prisma.$StaffProfilePayload>;
...
type GetStaffProfileGroupByPayload<T extends StaffProfileGroupByArgs> =
...
export type StaffProfileWhereInput = {
  ...
  date_joined?:
    | Prisma.DateTimeNullableFilter<'StaffProfile'>
    | Date
    | string
    | null;
...
export type StaffProfileScalarWhereWithAggregatesInput = {
  ...
  department_id?:
    | Prisma.StringNullableWithAggregatesFilter<'StaffProfile'>
    | string
    | null;
  date_joined?:
    | Prisma.DateTimeNullableWithAggregatesFilter<'StaffProfile'>
    | Date
    | string
    | null;
};
...
export type StaffProfileGetPayload<
  S extends boolean | null | undefined | StaffProfileDefaultArgs,
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, StaffProfileGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetStaffProfileGroupByPayload<T>
...
> = {
   ...
   */
  distinct?:
    | Prisma.StaffProfileScalarFieldEnum
    | Prisma.StaffProfileScalarFieldEnum[];
};
...
> = {
   ...
   */
  data: Prisma.XOR<
    Prisma.StaffProfileCreateInput,
...
> = {
   ...
   */
  data:
    | Prisma.StaffProfileCreateManyInput
    | Prisma.StaffProfileCreateManyInput[];
