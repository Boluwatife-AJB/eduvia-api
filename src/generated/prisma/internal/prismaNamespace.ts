    ...
    TeacherProfile: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.TeacherProfileCountAggregateOutputType>
            | number;
        };
      };
    };
    GuardianProfile: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.GuardianProfileCountAggregateOutputType>
            | number;
        };
      };
    };
    ...
    AcademicSession: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.AcademicSessionCountAggregateOutputType>
            | number;
        };
      };
    };
    AcademicTerm: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.AcademicTermCountAggregateOutputType>
            | number;
        };
      };
    };
    ...
    StudentSubjectRegistration: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.StudentSubjectRegistrationCountAggregateOutputType>
            | number;
        };
      };
    };
    TimeTableSlot: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.TimeTableSlotCountAggregateOutputType>
            | number;
        };
      };
    };
    TutorialClass: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.TutorialClassCountAggregateOutputType>
            | number;
        };
      };
    };
    ...
    LectureView: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.LectureViewCountAggregateOutputType>
            | number;
        };
      };
    };
 ...
 */
export type EnumSubjectTypeFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'SubjectType'
>;
 ...
 * Reference to a field of type 'SubjectType[]'
 */
export type ListEnumSubjectTypeFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'SubjectType[]'
>;
 ...
 */
export type EnumLectureContentTypeFieldRefInput<$PrismaModel> =
  FieldRefInputType<$PrismaModel, 'LectureContentType'>;

/**
 * Reference to a field of type 'LectureContentType[]'
 */
export type ListEnumLectureContentTypeFieldRefInput<$PrismaModel> =
  FieldRefInputType<$PrismaModel, 'LectureContentType[]'>;

/**
 * Reference to a field of type 'LectureStatus'
 */
export type EnumLectureStatusFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'LectureStatus'
>;
 ...
 * Reference to a field of type 'LectureStatus[]'
 */
export type ListEnumLectureStatusFieldRefInput<$PrismaModel> =
  FieldRefInputType<$PrismaModel, 'LectureStatus[]'>;
